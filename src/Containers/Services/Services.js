...
function Services
    ...
    return (
        <div className="services-container" id="services">
            ...
            <ServiceImage image={performance} price="From £80" title="Vocal and Acoustic Recording" text="Audio and video production of vocal and acoustic performances with top of the range equipment in our homely studio." flex="row-reverse" />
